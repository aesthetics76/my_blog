...
<section id="contents">
  <ul class="tab-nav nav">
   ...
   <div class="setting_step app_setting">
         <a class="step " href="<?php echo U('Home/MemberPublic/add',array('id'=>$id));?>">1.增加基本信息</a>
         <a class="step step_cur" href="<?php echo U('Home/MemberPublic/step_1',array('id'=>$id));?>">2.配置公众平台</a>
         <a class="step step_cur_1" href="<?php echo U('Home/MemberPublic/step_2',array('id'=>$id));?>">3.保存接口配置</a>
  </div>  
  <div class="tab-content"> 
    <!-- 表单 -->
    <form class="form-horizontal" method="post" action="<?php echo U('Home/MemberPublic/step_2',array('id'=>$id));?>" id="form">
      <!-- 基础文档模型 -->
  ...
  <div class="help_content">
      ...
      <p><img src="<?php echo SITE_URL;?>/Public/Home/images/help04.png" ></p>
  </div>  
</section>
