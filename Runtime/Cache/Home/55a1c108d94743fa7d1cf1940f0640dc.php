...
<section id="contents">
  ...
  <div class="setting_step app_setting">
         <a class="step step_cur" href="<?php echo U('Home/MemberPublic/add',array('id'=>$id));?>">1.增加基本信息</a>
         <a class="step step_cur_1" href="<?php echo U('Home/MemberPublic/step_1',array('id'=>$id));?>">2.配置公众平台</a>
         <a class="step " href="<?php echo U('Home/MemberPublic/step_2',array('id'=>$id));?>">3.保存接口配置</a>
  </div>   
  ...
  <div class="help_content">
        <p>URL(服务器地址)：<span style="color: #FF0000"><?php echo U('home/weixin/index',array('id'=>$id));?></span><br>
          Token(令牌)：<span style="color: #F00">weiphp</span><br>
          EncodingAESKey(消息加解密密钥)：点击随机生成得到密钥，不需要自己填写<br>
          消息加解密方式： 根据自己的需要选择其中一种
          </p>
          <p>&nbsp;</p>
          <p><a class="btn submit-btn" href="<?php echo U('Home/MemberPublic/step_2',array('id'=>$id));?>">下一步</a></p>
          <p>&nbsp;</p>
